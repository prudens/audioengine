...
int G7221_CALL g722_1_encode( g722_1_encode_state_t *s, uint8_t g722_1_data[], const int16_t amp[], int len )
{
...
g722_1_encode_state_t *G7221_CALL g722_1_encode_init( g722_1_encode_state_t *s, int bit_rate, int sample_rate )
{
#if !defined(G722_1_USE_FIXED_POINT)
    int i;
#endif
...
int G7221_CALL g722_1_encode_release( g722_1_encode_state_t *s )
{
    free(s);
    return 0;
}
