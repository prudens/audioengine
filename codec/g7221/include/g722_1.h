...
/*! Initialise a G.722.1 encode context.
    ...
    G7221_API g722_1_encode_state_t * G7221_CALL g722_1_encode_init( g722_1_encode_state_t *s, int bit_rate, int sample_rate );

/*! Release a G.722.1 encode context.
    \param s The G.722.1 encode context.
    \return 0. */
    G7221_API int G7221_CALL g722_1_encode_release( g722_1_encode_state_t *s );
...
/*! Encode a buffer of linear PCM data to G.722.1
    ...
    G7221_API int G7221_CALL g722_1_encode( g722_1_encode_state_t *s, uint8_t g722_1_data[], const int16_t amp[], int len );
...
G7221_API g722_1_decode_state_t * G7221_CALL g722_1_decode_init( g722_1_decode_state_t *s, int bit_rate, int sample_rate );

/*! Release a G.722.1 decode context.
    \param s The G.722.1 decode context.
    \return 0. */
G7221_API int G7221_CALL g722_1_decode_release( g722_1_decode_state_t *s );
...
G7221_API int G7221_CALL g722_1_decode( g722_1_decode_state_t *s, int16_t amp[], const uint8_t g722_1_data[], int len );
